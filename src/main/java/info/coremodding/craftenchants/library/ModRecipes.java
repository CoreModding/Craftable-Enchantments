...
/**
 * Mod recipes contain the shaped ingredients of the items and blocks of the mod. Items and blocks
...
public class ModRecipes {
  ...
  public static class Items {
    ...
    public static final Object[] snorkle = new Object[] {"GGS", "GGG", "III", 'G', Block.glass,
        'S', new ItemStack(Item.reed), 'I', new ItemStack(Item.ingotIron)};
